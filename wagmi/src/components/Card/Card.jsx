...
const CardComponent = ({ title, content }) => {
	return (
		<div className="relative w-[38vw] h-[39.6108vw] md:w-[19.18665vw] md:h-[19.8vw] rounded-[14px] overflow-hidden border-wagmi-blue border-[2px] md:border-[4px] border-solid bg-wagmi-white p-[.2vw] flex flex-col justify-start transition-transform duration-300 ease-out hover:-translate-y-[10px]">
			{/* Title at the top */}
