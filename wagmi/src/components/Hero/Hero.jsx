...
const Hero = () => {
	...
	return (
		<div className="w-full h-screen bg-wagmi-white flex flex-col items-center">
			<div className="text-wagmi-blue text-center font-gilmer text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-9xl 2xl:text-[10rem] lg:mt-[12vh] lg:mb-[14vh] mt-[6vh] mb-[8vh]">
