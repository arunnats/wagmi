...
const JoinUs = () => {
	...
	return (
		<>
			<div className="w-[60vw]  mx-auto mt-[5vh] md:mt-[3vh] lg:mt-[10vh] transition-transform duration-300 ease-out hover:-translate-y-[10px]">
				<div
				...
				>
					...
					<div className="mx-auto w-[90%]  text-wagmi-blue text-justify font-gilmer text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl p-2 md:p-4">
						<h3>
