...
const Carousel = () => {
	return (
		<div className="flex justify-center mt-8 w-[80vw] h-[55vh] mx-auto bg-wagmi-offwhite border-wagmi-blue rounded-box border-[2px] md:border-[4px] border-solid">
			<div className="rounded-box px-3 md:px-6 md:p-6">
				<CCarousel controls>
					<CCarouselItem>
						<CImage
							className="d-block max-h-[45vh] mx-auto aspect-[16/9] object-cover"
							src={one}
							alt="slide 1"
						/>
					</CCarouselItem>
					...
					<CCarouselItem>
						<CImage
							className="d-block w-full mx-auto max-h-[45vh] aspect-[16/9] object-cover"
							src={six}
							alt="slide 6"
						/>
					</CCarouselItem>
