...
import { FaFacebookF, FaTwitter, FaInstagram } from "react-icons/fa"; // Example icons

const Footer = () => {
	return (
		<div className="flex justify-around items-center h-[250px] bg-wagmi-blue relative mt-[12vh] md:mt-[14vh] lg:mt-[18vh] px-8">
			...
			<div className="w-[33vw] h-[200px]">
				<div className="text-center flex flex-col items-center">
					...
					<div className="mt-24">
						<p className="text-wagmi-white font-semibold font-gilmer">
			...
			<div className="w-[20vw] h-[30vh] ">
				<div className="flex flex-col justify-center text-wagmi-white">
